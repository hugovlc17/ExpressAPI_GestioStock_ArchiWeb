...
export const createDemandeRendu = async (req, res) => {
    const { id_utilisateur, id_materiel, id_attribution } = req.body;
...
export default { getAllDemandesRendu, createDemandeRendu, getDemandeRenduUserID, deleteDemandeRendu, validerDemandeRendu };
